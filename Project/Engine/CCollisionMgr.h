...
private:
    ...
    map<UINT_PTR, bool>     m_mapPrevInfo;      // 이전 프레임에서 두 충돌체의 충돌여부
...
private:
    ...
    bool CollisionBtwRectCollider(CCollider2D* _pLeft, CCollider2D* _pRight);
    bool CollisionBtwCirCleCollider(CCollider2D* _pLeft, CCollider2D* _pRight);
};
