...
CEndBtnScript::CEndBtnScript(const CEndBtnScript& _Other)
	: CScript(ENDBTNSCRIPT)
	, m_NormalImg(nullptr)
	, m_HoverImg(nullptr)
	, m_CurImg(nullptr)
...
void CEndBtnScript::begin()
{
	m_NormalImg = CAssetMgr::GetInst()->Load<CTexture>(L"texture\\Title\\Title_Exit_Idle.png", L"texture\\Title\\Title_Exit_Idle.png");
	m_HoverImg = CAssetMgr::GetInst()->Load<CTexture>(L"texture\\Title\\Title_Exit_Over.png", L"texture\\Title\\Title_Exit_Over.png");
...
void CEndBtnScript::OnUnHovered()
{
	m_CurImg = m_NormalImg;
	m_LeftSword->SetActive(false);
	m_RightSword->SetActive(false);
...
void CEndBtnScript::LBtnReleased()
{
	m_CurImg = m_NormalImg;
	m_bMouseLBtnDown = false;
	m_LeftSword->SetActive(false);
...
void CEndBtnScript::LBtnClicked()
{
	m_CurImg = m_NormalImg;
	m_LeftSword->Destroy();
	m_RightSword->Destroy();
