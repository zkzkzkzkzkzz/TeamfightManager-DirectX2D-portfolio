...
CTitleLevel::CTitleLevel(const CTitleLevel& _Origin)
	: m_bBGM(false)
{
}
...
void CTitleLevel::finaltick()
{
	CLevel::finaltick();
}


void CTitleLevel::InitUI()
{
	GetLayer(0)->SetName(L"Default");
	GetLayer(1)->SetName(L"Light");
	GetLayer(2)->SetName(L"Background");
	GetLayer(5)->SetName(L"Cursor");
